...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props) {
        ...
        DatabaseInstance authServiceDb = createDatabaseInstance(
        ...
        FargateService authService = createFargateService("AuthService"
                ...
                , List.of(4005)
                ,authServiceDb,
                Map.of("JWT_SECRET","b5f8c9c4a3e7423f8c9a634be2ff5d8d5b7d2e7633e1f9a37bc3d2a2c6e847c7")
        );
    ...
    private DatabaseInstance createDatabaseInstance(String id, String databaseName) {
